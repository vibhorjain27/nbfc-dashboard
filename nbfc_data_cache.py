...
NBFC_TIMESERIES = {
    ...
    "L&T Finance": {
        "aum_cr":                [93015,  95120,  97762,  102314, 107096, 114285, 121728, None],
        "gnpa_pct":              [3.2,   3.23,  3.29,  3.31,  3.29,  3.19,  2.88,  None],
        "nnpa_pct":              [0.97,  0.97,  0.99,  1,     1,     0.92,  0.96,  None],
        "pcr_pct":               [71,    71,    71,    70,    72,    72,    67,    None],
        "pat_cr":                [626,   636,   701,   735,   760,   760,   807,   None],
        "nim_pct":               [10.86, 10.33, 10.15, 10.22, 10.22, 10.41, 10.47, None],  # NIM + Fees, from Q4FY26 investor deck (RoA trajectory table)
        "roa_pct":               [2.27,  2.22,  2.37,  2.41,  2.41,  2.37,  2.4,   None],
        "roe_pct":               [11.65, 10.2,  10.5,  11.33, 11.33, 11.38, 11.71, None],
        "cost_of_borrowing_pct": [7.83,  7.8,   7.68,  7.4,   7.32,  7.25,  7.17,  None],  # WACB from Q4FY26 investor deck (ALM slide)
        "d_e_ratio":             [3.5,   3.46,  3.66,  3.71,  3.78,  3.78,  3.93,  None],
        "car_pct":               [22.16, 22,    22.27, 20.68, 20,    19.1,  18.34, None],
        "t1_pct":                [20.53, None,  20.76, 19.54, None,  18.43, 17.6,  None],
        "t2_pct":                [1.63,  None,  1.51,  1.14,  None,  0.67,  0.74,  None],
        "bvps_inr":              [99.9,  99.9,  102.4, 105.4, 108.3, 108.3, 111.7, None],
    },
    "Piramal Finance": {
