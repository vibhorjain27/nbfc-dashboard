...
NBFC_AI_INITIATIVES = {
    ...
    "Bajaj Finance": [
        ...
        {
            "title": "AI Call Centre Drives Rs 1,600 Crore Loan Disbursements",
            "description": (
    ...
    "Aditya Birla Capital": [
        ...
        {
            "title": "AI-First Strategy Accelerated with Enterprise-Wide GenAI Tools",
            "description": (
    ...
    "Piramal Finance": [
        ...
        {
            "title": "Claude AI Used to Build Software at 1/10th the Cost",
            "description": (
        ...
        {
            "title": "Embedded Finance with 22 Partners via API Stack",
            "description": (
    ...
    "Muthoot Finance": [
        ...
        {
            "title": "Muthoot Finclusion Challenge 2025: AI Innovation for Financial Inclusion",
            "description": (
    ...
    "Mahindra Finance": [
        ...
        {
            "title": "AI Collections Efficiency via Credgenics: 25% Improvement",
            "description": (
    ...
    "Poonawalla Fincorp": [
        ...
        {
            "title": "AI Competition Benchmarking Engine for Pricing Intelligence",
            "description": (
        ...
        {
            "title": "AI-Powered Underwriting System Announced (Finance Director Europe Coverage)",
            "description": (
